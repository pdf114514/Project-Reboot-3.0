#include "_CommunicateServer.h"
CommunicateServer cServer;

void SetupCommunicateServer() {
    WSADATA wsaData;
...
void ShutdownCommunicateServer() {
    cServer.Stop();
    WSACleanup();
}
...
BOOL APIENTRY DllMain(HMODULE hModule, DWORD reason, LPVOID lpReserved)
{
    ...
    case DLL_PROCESS_ATTACH:
        SetupCommunicateServer();
        CreateThread(0, 0, Main, 0, 0, 0);
        break;
    case DLL_PROCESS_DETACH:
        ShutdownCommunicateServer();
        break;
    }
    return TRUE;
}
